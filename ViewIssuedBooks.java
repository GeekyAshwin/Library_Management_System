...
class ViewissuedBooks implements ActionListener
{
    ...
    ViewissuedBooks(){
        ...
        l1.setBounds(40,45,120,45);
        l1.setFont(font3);
        c.add(l1);

        l2=new JLabel("BookName");
        l2.setBounds(160,45,120,45);
        l2.setFont(font3);
        c.add(l2);

        l3=new JLabel("Student Name");
        l3.setBounds(285,45,120,45);
        l3.setFont(font3);
        c.add(l3);

        l4=new JLabel("Student ID");
        l4.setBounds(393,45,125,45);
        l4.setFont(font3);
        c.add(l4);

        l5=new JLabel("ContactNo.");
        l5.setBounds(530,45,120,45);
        l5.setFont(font3);
        c.add(l5);

        l6=new JLabel("Date of Issue");
        l6.setBounds(641,45,120,45);
        l6.setFont(font3);
        c.add(l6);
